...
const ZoomSelector = () => {
  ...
  return (
    <>
      <button
        disabled={!isPDFViewerLoaded || currentScale <= 0.1}
      ...
      <Menu as="div" className="text-xs w-32 relative py-1 bg-gray-200 rounded">
      ...
      <button
        disabled={!isPDFViewerLoaded || currentScale >= 10}
        className="enabled:hover:bg-gray-200 enabled:hover:text-black text-gray-500 disabled:text-gray-300 py-1 px-1 rounded transition-all group relative"
